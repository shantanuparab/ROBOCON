...
struct MotorController
{
	...
	MotorController(const Pin p_direction, const Pin p_pwm, const uint8_t p_direction_straight = HIGH)
	...
	private:
	inline constexpr uint8_t reverseDirection() const
	{
		// Simply Returns the Opposite of Straight Direction
		return (m_direction_straight == HIGH) ? LOW : HIGH;
	}
   inline constexpr uint8_t straightDirection() const
	{
